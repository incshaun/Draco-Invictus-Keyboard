...
void BleKeyboard::sendReport(KeyReport* keys)
{
  ...
  Serial.print (keys->keys[0], HEX);
  Serial.print ("-");
  Serial.print (keys->keys[1], HEX);
  Serial.print ("-");
  Serial.print (keys->keys[2], HEX);
  Serial.print ("-");
  Serial.print (keys->keys[3], HEX);
  Serial.print ("-");
  Serial.print (keys->keys[4], HEX);
  Serial.print ("-");
  Serial.print (keys->keys[5], HEX);
  Serial.print (":");
  Serial.print (keys->modifiers, HEX);
  Serial.print ("-");
  Serial.print (keys->reserved, HEX);
  Serial.println ();
  if (this->isConnected())
  {
